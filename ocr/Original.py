...
path, dirs, files = next(os.walk("../public/storage/informationsystem-926ad.appspot.com/demo/"))
# path, dirs, files = next(os.walk("C:/xampp/htdocs/Projects/land-transportation-franchising-and-regulatory-board/ltfrbr10infosystem/public/storage/informationsystem-926ad.appspot.com/images"))
                    ...
                    if expiryDate.year > current_date.year:
                        ...
                        try:
                            ...
                            if count == 0:
                                ...
                                notif_date = str(row[5].year)+'-'+str(row[5].month)+'-'+str(row[5].day)
