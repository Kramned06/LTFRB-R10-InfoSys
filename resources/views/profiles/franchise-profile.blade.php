...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <form method="POST" action="{{ action('ProfileController@update', Auth::user()->id) }}">@csrf
            <div class="modal fade bd-example-modal-lg" id="view_updateprofile{{ Auth::user()->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="container emp-profile">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="profile-head">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-selected="true">About</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="">
                        <button type="button" class="btn-sm btn btn-dark" data-toggle="modal" data-target="#view_updateprofile{{ Auth::user()->id }}">Edit Profile</button>
                    </div>
                </div>
            </div>
        </div>
